...
run.data <- list(
  list(run_number = 1,
       population_one=list(type = "standard normal",
                        size = 10),
       population_two=list(type = "standard normal",
                        size = 10)),
  list(run_number = 2,
       population_one=list(type = "standard normal",
                        size = 10),
       population_two=list(type = "normal",
                        mean = 1,
                        sd = 10,
                        size = 10)),
  list(run_number = 3,
       population_one=list(type = "t-student",
                        df = 4,
                        size = 10),
       population_two=list(type = "t-student",
                        df = 4,
                        size = 10)),
  list(run_number = 4,
       population_one=list(type = "exponential",
                        rate = 4,
                        size = 10),
       population_two=list(type = "exponential",
                        rate = 4,
                        size = 10)),
  list(run_number = 5,
       population_one=list(type = "normal",
                        mean = 10,
                        sd = 2,
                        size = 10),
       population_two=list(type = "exponential",
